...
export const CultrahusLogo: React.FC<CultrahusLogoProps> = ({
  ...
  return (
    <div className={`inline-flex items-center gap-3 ${className}`}>
      <div
        className={`relative ${sizeMap[size]} shrink-0 rounded-full overflow-hidden border border-[#556342]/40 shadow-md bg-[#f7f4ec] transition-transform duration-200 hover:scale-105 flex items-center justify-center`}
      >
        {!imgError ? (
          <img
          ...
          <div className="w-full h-full bg-[#3b4928] text-[#f7f4ec] flex items-center justify-center font-serif font-bold text-base">
            C
          </div>
        )}
      </div>
